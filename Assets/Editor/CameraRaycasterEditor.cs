...
public class CameraRaycasterEditor : Editor
{
	...
	void BindStringToPrint()
	{
		var stringProp = serializedObject.FindProperty("stringToPrint");
		stringProp.stringValue = EditorGUILayout.TextField("String to Print:", stringProp.stringValue);
	}
}
